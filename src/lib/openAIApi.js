  ...
  return fetch("https://api.openai.com/v1/chat/completions", {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: "system",
          content: `Tu nombre es ${pet.name}. Tu personalidad es ${pet.description}. Responderás simulando ser la mascota asignada. La conversación debe ser fluida y natural. Siempre ten en cuenta tu nombre y personalidad para cada respuesta, incluye emojis. Tus respuestas serán cortas de no más de 30 palabras.`,
        },
        {
          role: "user",
          content: messages,
