...
const Home = () => {
  ...
  function actualizarVista() {
    ...
    document
      .getElementById("contenido-tarjetas")
      .appendChild(renderItems(resultadosFiltrados));
  }
  ...
  botonOrdenarAsc.addEventListener("click", function () {
    ...
    const ordenarPetsData = orderPetsBy(
      resultadosFiltrados,
      "name",
      valorElegido
    );
    document
      .getElementById("contenido-tarjetas")
      .appendChild(renderItems(ordenarPetsData));
  });
